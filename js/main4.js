                   ...
                   function($scope, REService) {
                       ...
                       $scope.init = function() {
                           ...
                           if (data.length === 1) {
                               ...
                               //scope.onSelectNextWords(new UserSelection('grammar_if_statement', 'if', 0, 0, true, "Keywords", "KEYWORD"), null, null);
                           } else {
                               $scope.rules = data;
                               $scope.elements = data;
                       ...
                       $scope.onSelectElement = function($item, $model, $label) {
                           ...
                           var data = REService.getNextWord($item, $scope.variables);
                           if (data.length > 0) {
                               var filteredData = [];
                ...
                function() {
                    return {
                        getElements : function(variables) {
                            ...
                            var data = getSuggestionsWhenNothingIsChosen("grammar_arithmetic_expression");
                        ...
                        getNextWord : function(userSelection, variables) {
                            console.log("getting suggestions for : " + JSON.stringify(userSelection));
                            var data = getSuggestionsForUserSelection(userSelection);
                            console.log("output : " + JSON.stringify(data));
